...
s.pctAgreedLong =
  "의견 {{comment_id}}에 투표한 전체 참여자 중 {{pct}}%가 동의했습니다.";
s.pctAgreedOfGroup = "그룹 {{group}}의 {{pct}}%가 동의";
s.pctDisagreedOfGroup = "그룹 {{group}}의 {{pct}}%가 비동의";
s.pctDisagreedLong =
  "의견 {{comment_id}}에 투표한 전체 참여자 중 {{pct}}%가 비동의했습니다.";
s.pctAgreedOfGroupLong =
  "그룹 {{group}}에서 의견 {{comment_id}}에 투표한 참여자 중 {{pct}}%가 동의했습니다.";
s.pctDisagreedOfGroupLong =
  "그룹 {{group}}에서 의견 {{comment_id}}에 투표한 참여자 중 {{pct}}%가 비동의했습니다.";
s.participantHelpGroupsText =
  "파란색 원이 당신을 나타내며, 비슷한 관점을 가진 사람들과 함께 그룹으로 묶여 있습니다.";
s.participantHelpGroupsNotYetText =
  "7명의 참여자가 투표를 시작하면 시각화가 나타납니다";
...
s.commentTooLongByChars =
  "의견 길이가 {{CHARACTERS_COUNT}}자 초과되었습니다.";
s.submitComment = "제출";
s.commentSent =
  "의견이 제출되었습니다! 다른 참여자들만 당신의 의견을 보고 동의 또는 비동의할 수 있습니다.";

// Error notices

s.commentSendFailed = "의견 제출 중 오류가 발생했습니다.";
s.commentSendFailedEmpty =
  "의견 제출 중 오류가 발생했습니다 - 의견이 비어 있으면 안 됩니다.";
s.commentSendFailedTooLong =
  "의견 제출 중 오류가 발생했습니다 - 의견이 너무 깁니다.";
s.commentSendFailedDuplicate =
  "의견 제출 중 오류가 발생했습니다 - 동일한 의견이 이미 존재합니다.";
s.commentErrorDuplicate = "중복! 해당 의견이 이미 존재합니다.";
s.commentErrorConversationClosed =
  "이 대화는 종료되었습니다. 더 이상 의견을 제출할 수 없습니다.";
...
s.xidOidcConflictWarning = "경고: 현재 Polis에 로그인되어 있지만, XID 토큰이 포함된 대화를 열었습니다. XID로 참여하려면 Polis 계정에서 로그아웃해 주세요.";
...
s.notificationsEnterEmail =
  "더 많은 의견이 도착하면 알림을 받을 이메일 주소를 입력하세요:";
s.labelEmail = "이메일";
...
s.topic_good_01_reason =
  "열린 질문으로, 누구나 이 질문의 답에 대한 의견을 가질 수 있습니다";
...
s.invite_code_invalid = "제공된 초대 코드가 유효하지 않습니다. 다시 시도해 주세요."

// Treevite login code strings
s.invite_code_accepted_message = "초대가 수락되었습니다. 로그인 코드: {{login_code}}. 이 코드를 비밀번호처럼 취급하세요 — 안전한 곳에 저장하세요. 나중에 다시 로그인할 때 반드시 필요하며, 분실 시 재발급이 불가합니다.";
s.invite_code_accepted_message_no_code = "초대가 수락되었습니다.";
s.login_code_prompt = "로그인 코드 입력";
s.submit_login_code = "로그인 코드 제출";
s.login_code_invalid = "제공된 로그인 코드가 유효하지 않습니다. 다시 시도해 주세요.";
s.login_success = "성공! 로그인되었습니다.";
s.submitting = "제출 중...";
s.or_text = "또는";
s.copy = "복사";
s.copied = "복사됨";
s.ok_got_it = "확인했습니다";
s.invites_link = "초대";
s.invites_wave_sentence = "{{wave}}차에 해당합니다. {{date}}에 참여함";
s.invites_instructions = "새 참여자를 초대하려면 이 초대 코드를 복사하여 공유하세요:";
s.invites_none = "아직 초대가 없습니다.";
